...
class ObjectDataCubit extends Cubit<ObjectInputDataState> {
  ...
  final DesignInputDataVMBuilder _objectDataBuilder;
  ...
  ObjectDataCubit(DBClient dbClient)
    : _dataSourceLocal = DesignPresaleDataSourceLocal(dbClient),
      _objectDataBuilder = DesignInputDataVMBuilder(),
  ...
  void nextPage() async {
    try {
      DesignInputDataVM? inputDataMv = _objectDataBuilder.build();
      ObjectDataDesign objectDataData = inputDataMv.toObject();
      InputFactors inputFactorsPojo = inputDataMv.toFactors();
      ...
      DesignPresale designPresalePojo = DesignPresale(
        inputDataDesign: inputDataDesign,
      );
      print(designPresalePojo);
