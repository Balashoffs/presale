...
class DesignOfferCubit extends Cubit<DesignOfferState> {
  ...
  void init() async {
    ...
    bool isBuild = _designOfferController.buildModel(designPresalePojo, _divisionType);
    if(isBuild){
      emit(DesignOfferState.showPage(_designOfferController.designOfferResultVM!));
    }
