...
class _$AppConfigImpl extends _AppConfig {
  const _$AppConfigImpl({required this.password}) : super._();
  ...
  @override
  String toString() {
    return 'AppConfig(password: $password)';
  }
...
abstract class _AppConfig extends AppConfig {
  const factory _AppConfig({required final String password}) = _$AppConfigImpl;
