...
mixin _$InputDataDesign {
  ...
  ObjectDataDesign get objectData =>
      throw _privateConstructorUsedError; // Данные о коэфициентах
  InputFactors get inputFactors =>
...
class _$InputDataDesignImpl implements _InputDataDesign {
  ...
  @override
  final InputFactors inputFactors;
...
abstract class _InputDataDesign implements InputDataDesign {
  const factory _InputDataDesign({
    ...
    required final InputFactors inputFactors,
  ...
  @override
  ObjectDataDesign get objectData; // Данные о коэфициентах
  @override
  InputFactors get inputFactors; // Тип проектной документации на выходе
  @override
