...
DesignPresale _$DesignPresalePojoFromJson(Map<String, dynamic> json) {
...
mixin _$DesignPresalePojo {
  ...
  $DesignPresalePojoCopyWith<DesignPresale> get copyWith =>
      throw _privateConstructorUsedError;
}
...
abstract class $DesignPresalePojoCopyWith<$Res> {
  factory $DesignPresalePojoCopyWith(
    DesignPresale value,
    $Res Function(DesignPresale) then,
  ) = _$DesignPresalePojoCopyWithImpl<$Res, DesignPresale>;
  @useResult
  $Res call({
...
/// @nodoc
class _$DesignPresalePojoCopyWithImpl<$Res, $Val extends DesignPresale>
...
abstract class _DesignPresalePojo implements DesignPresale {
